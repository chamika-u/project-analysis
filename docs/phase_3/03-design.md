...
```
### Explanation:
- **Students**: The primary users who submit their medical certificates through the system.
- **Medical Officers**: The users responsible for reviewing and approving submitted medical certificates.
- **Medical Submission Management System**: The central system that handles all interactions between students and medical officers.
- **Submission Records**: The database where all submitted medical certificates and their statuses are stored.
- **Statistics Reports**: The output generated by the system that provides insights into submissions, statuses, and types.
